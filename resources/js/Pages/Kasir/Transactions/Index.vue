    ...
    <AuthenticatedLayout>
        ...
        <template #header>
            <div class="flex justify-between items-center">
                ...
                <Link
                    v-if="can('transactions.topup')"
                    :href="route('kasir.transactions.topup.form')"
        ...
        <div class="py-12 bg-gray-100 dark:bg-slate-900 min-h-screen transition-colors duration-200">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                ...
                <EmptyState
                    ...
                    :action-url="can('transactions.topup') ? route('kasir.transactions.topup.form') : null"
                    :action-text="can('transactions.topup') ? 'Top-up Saldo Siswa' : null"
                />
            </div>
        </div>
    </AuthenticatedLayout>
