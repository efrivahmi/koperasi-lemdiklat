            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl rounded-lg p-8">
                    ...
                    <div class="flex gap-4">
                        <Link :href="route('teachers.edit', teacher.id)" class="inline-flex items-center px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-semibold shadow-sm">Edit Guru</Link>
                        <Link :href="route('teachers.index')" class="inline-flex items-center px-6 py-3 bg-gray-500 hover:bg-gray-600 text-white rounded-lg font-semibold shadow-sm">Kembali</Link>
                    </div>
                </div>
            </div>
        </div>
