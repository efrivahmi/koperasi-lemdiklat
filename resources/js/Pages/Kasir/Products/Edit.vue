...
const submit = () => {
    if (form.image) {
        ...
        form.post(route('kasir.products.update', props.product.id), {
            forceFormData: true,
            _method: 'put',
        });
    } else {
        // If no new image, use PUT directly
        form.put(route('kasir.products.update', props.product.id));
    }
};
</script>
                ...
                <div class="mb-6 bg-gradient-to-r from-purple-600 via-indigo-600 to-blue-600 rounded-lg shadow-lg p-6 text-white">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-purple-100 text-sm">Perbarui informasi produk koperasi</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6 sm:p-8 text-gray-900 dark:text-gray-100">
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-4">
                                ...
                                <Link :href="route('kasir.products.index')" class="inline-flex items-center justify-center px-6 py-3 bg-gray-500 hover:bg-gray-600 text-white rounded-lg font-semibold text-sm transition shadow-sm w-full sm:w-auto">
