...
const submit = () => form.post(route('savings.store'));
                ...
                <div class="bg-slate-800/50 backdrop-blur-md overflow-hidden shadow-xl rounded-xl border border-white/10 p-6 sm:p-8">
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="flex flex-col sm:flex-row gap-3">
                            ...
                            <Link :href="route('savings.index')" class="inline-flex items-center justify-center px-6 py-3 bg-slate-700 hover:bg-slate-600 text-white rounded-lg font-semibold border border-white/10 w-full sm:w-auto">Batal</Link>
                        </div>
                    </form>
                </div>
            </div>
