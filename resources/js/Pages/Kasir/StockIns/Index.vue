...
watch(search, (value) => {
    router.get(route('kasir.stock-ins.index'), { search: value }, {
        replace: true,
    });
});
            ...
            <div class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
                ...
                <div class="mb-6 bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-gray-800 dark:to-gray-800 border border-purple-200 dark:border-purple-500/30 rounded-lg shadow-sm p-4">
                    <div class="flex flex-col lg:flex-row gap-4 items-stretch lg:items-center">
                        ...
                        <!-- Action Button -->
                        <Link v-if="can('stock_ins.create')" :href="route('kasir.stock-ins.create')" class="inline-flex items-center justify-center px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-lg shadow-sm transition">
