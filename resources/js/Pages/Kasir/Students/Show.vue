        ...
        <template #header>
            <div class="flex justify-between items-center">
                ...
                <div class="flex gap-2">
                    ...
                    <Link :href="route('kasir.students.topup', student.id)" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                        Top-up
                    </Link>
                    <Link :href="route('kasir.students.edit', student.id)" class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded">
                        Edit
                    </Link>
                    <Link :href="route('kasir.students.index')" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
                        Kembali
                    </Link>
                </div>
            </div>
