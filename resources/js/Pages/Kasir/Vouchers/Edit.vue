...
const submit = () => {
    form.put(route('kasir.vouchers.update', props.voucher.id));
};
    ...
    <AuthenticatedLayout>
        ...
        <template #header>
            <div class="flex justify-between items-center">
                ...
                <Link :href="route('kasir.vouchers.index')" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100">
                    &larr; Kembali
                </Link>
            </div>
        </template>
