                        ...
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    />
                                    <p v-if="student.rfid_uid" class="mt-1 text-sm text-gray-500">Gunakan halaman "RFID Register" untuk mengubah RFID</p>
                            ...
                            <div>
                                ...
                                <div v-if="student.foto && !fotoPreview" class="mb-3">
                                    ...
                                    <img :src="`/storage/${student.foto}`" :alt="student.user.name" class="h-32 w-32 object-cover rounded-full" />
                                </div>
                                <input
                                    id="foto"
                                    type="file"
