...
const search = () => router.get(route('kasir.transactions.index'), searchForm.value, { preserveScroll: true });
                                        ...
                                        <tr v-for="t in transactions.data" :key="t.id" class="hover:bg-white/5 transition-colors">
                                            ...
                                            <td class="px-4 py-4 whitespace-nowrap text-sm font-medium">
                                                <div class="flex items-center gap-2">
                                                    <Link v-if="t.student" :href="route('kasir.transactions.student', t.student.id)" class="text-sky-400 hover:text-sky-300 transition-colors" title="Riwayat Siswa">📋</Link>
