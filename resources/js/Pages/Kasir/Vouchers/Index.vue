...
const deleteVoucher = (id) => {
    if (confirm('Hapus voucher ini?')) {
        router.delete(route('kasir.vouchers.destroy', id));
    }
};
...
const printVoucher = (voucherId) => {
    window.open(route('kasir.vouchers.print', voucherId), '_blank');
};
...
const printSelectedVouchers = () => {
    ...
    router.post(route('kasir.vouchers.print.batch'), {
        ...
        onSuccess: () => {
            ...
            form.method = 'POST';
            form.action = route('kasir.vouchers.print.batch');
            form.target = '_blank';
        ...
        <div class="py-6 sm:py-12">
            <div class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
                ...
                <div class="mb-6 bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-gray-800 dark:to-gray-800 border border-purple-200 dark:border-purple-500/30 rounded-lg shadow-sm p-4">
                    <div class="flex flex-col lg:flex-row gap-4 items-stretch lg:items-center">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <button
                                v-if="selectedVouchers.length > 0 && can('vouchers.print')"
                            ...
                            <Link v-if="can('vouchers.redeem')" :href="route('kasir.vouchers.redeem.form')" class="flex-1 sm:flex-initial inline-flex items-center justify-center px-4 py-2.5 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-lg shadow-sm transition">
                                <svg class="w-5 h-5 sm:mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <Link v-if="can('vouchers.create')" :href="route('kasir.vouchers.create')" class="flex-1 sm:flex-initial inline-flex items-center justify-center px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-lg shadow-sm transition">
                                <svg class="w-5 h-5 sm:mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <EmptyState
                    ...
                    :action-url="route('kasir.vouchers.create')"
                                ...
                                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                    <tr v-for="voucher in vouchers.data" :key="voucher.id"
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex items-center gap-2">
                                                <button
                                                    v-if="voucher.status === 'available' && can('vouchers.print')"
                                                ...
                                                <button
                                                    v-if="voucher.status === 'available' && can('vouchers.delete')"
