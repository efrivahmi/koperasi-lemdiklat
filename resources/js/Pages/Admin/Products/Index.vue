                ...
                <div class="relative z-30 mb-6 bg-slate-800/50 backdrop-blur-md border border-white/10 rounded-xl shadow-2xl p-4 space-y-4">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <Link v-if="can('products.create')" :href="route('products.create')" class="inline-flex items-center justify-center px-4 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white text-sm font-semibold rounded-lg shadow-lg shadow-indigo-500/20 hover:shadow-indigo-500/40 transition-all duration-200">
                                <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" /></svg>
                                Tambah Produk
                            </Link>
                            <Link v-if="can('products.create')" :href="route('products.barcode-generator')" class="inline-flex items-center justify-center px-4 py-2 bg-slate-700 hover:bg-slate-600 text-white text-sm font-semibold rounded-lg border border-white/10 transition-all duration-200">
                    ...
                    <div class="flex gap-2">
                        <div class="relative flex-1">
                            ...
                            <input 
                                v-model="search"
                                @keydown.enter="router.get(route('products.index'), { search: search, sort: sortBy }, { preserveState: true, replace: true })"
                                type="text" 
                        ...
                        <button 
                            @click="router.get(route('products.index'), { search: search, sort: sortBy }, { preserveState: true, replace: true })"
                        ...
                        <button 
                            v-if="filters.search"
                            @click="search = ''; router.get(route('products.index'), { sort: sortBy }, { preserveState: true, replace: true })"
