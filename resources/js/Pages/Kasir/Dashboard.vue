    ...
    <AuthenticatedLayout>
        ...
        <div class="py-8 min-h-screen relative">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8 space-y-6 relative z-10">
                ...
                <!-- Today's Stats Row -->
                <!-- Stats Bento Grid -->
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:auto-rows-[160px]">
                    ...
                    <div class="bg-slate-900/60 backdrop-blur-md overflow-hidden sm:rounded-2xl p-6 border border-slate-700/50 shadow-xl animate-fade-in-up animation-delay-600 relative">
                        ...
                        <div class="relative z-10">
                            <div class="flex justify-between items-center mb-6">
                                ...
                                <Link v-if="hasPermission('transactions.history')" :href="route('transactions.index')" class="text-xs px-3 py-1.5 bg-slate-700 hover:bg-slate-600 text-slate-200 rounded-md transition border border-slate-600">
                                    Lihat Semua →
                                </Link>
                            </div>
                            <div class="space-y-3">
                ...
                <div class="mt-8 pt-4 pb-4">
                    ...
                    <div class="bg-gradient-to-r from-indigo-500/20 via-purple-600/20 to-pink-600/20 backdrop-blur-xl border border-white/10 rounded-3xl p-4 shadow-2xl">
                        <div class="flex flex-wrap md:flex-nowrap justify-around gap-4 md:gap-8">
                            <Link v-if="hasPermission('products.view')" :href="route('kasir.products.index')" class="flex flex-col items-center gap-3 transition-transform duration-300 hover:scale-110 group w-24">
                                ...
                                <span class="text-xs font-semibold text-slate-200 text-center whitespace-nowrap drop-shadow-md">Data Produk</span>
                            </Link>
                            
                            <Link v-if="hasPermission('transactions.topup')" :href="route('transactions.topup.form')" class="flex flex-col items-center gap-3 transition-transform duration-300 hover:scale-110 group w-24">
                                ...
                                <span class="text-xs font-semibold text-slate-200 text-center whitespace-nowrap drop-shadow-md">Top-up Saldo</span>
                            </Link>

                            <Link v-if="hasPermission('stock_ins.create')" :href="route('stock-ins.create')" class="flex flex-col items-center gap-3 transition-transform duration-300 hover:scale-110 group w-24">
                                ...
                                <span class="text-xs font-semibold text-slate-200 text-center whitespace-nowrap drop-shadow-md">Tambah Stok</span>
                            </Link>

                            <Link v-if="hasPermission('reports.stock_adjustments')" :href="route('kasir.reports.stock-adjustments')" class="flex flex-col items-center gap-3 transition-transform duration-300 hover:scale-110 group w-24">
                                ...
                                <span class="text-xs font-semibold text-slate-200 text-center drop-shadow-md leading-tight">Penyesuaian<br>Stok</span>
                            </Link>
                        </div>
                    </div>
                </div>
