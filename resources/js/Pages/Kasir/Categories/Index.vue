                    ...
                    >
                        <template #search-input>
                             <SearchableSelect
                                ...
                                label-key="name"
                                value-key="name"
                                @update:model-value="val => router.get(route('kasir.categories.index'), { search: val }, { preserveState: true, replace: true })"
                                class="w-full"
                            />
                        </template>
                        <template #actions>
                            <Link v-if="can('categories.create')" :href="route('kasir.categories.create')" class="w-full sm:w-auto inline-flex items-center justify-center px-5 py-2.5 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white font-semibold rounded-lg shadow-lg shadow-indigo-500/20 hover:shadow-indigo-500/40 transition-all duration-200 transform hover:-translate-y-0.5">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex items-center justify-end space-x-3">
                                                 <Link 
                                                    ...
                                                    :href="route('kasir.categories.show', category.id)" 
                                                ...
                                                <Link 
                                                    ...
                                                    :href="route('kasir.categories.edit', category.id)" 
                                        ...
                                        <tr v-for="child in category.children" :key="child.id" class="bg-slate-900/30 hover:bg-slate-800/50 transition-colors">
                                            ...
                                            <td class="px-6 py-3 whitespace-nowrap text-right text-sm font-medium">
                                                <div class="flex items-center justify-end space-x-3">
                                                    ...
                                                    <Link v-if="can('categories.edit')" :href="route('kasir.categories.edit', child.id)" class="text-indigo-400 hover:text-indigo-300 transition-colors">
                                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" /></svg>
                                                    </Link>
