...
const printBarcode = () => {
    window.open(route('kasir.products.print-barcode', props.product.id), '_blank');
};
        ...
        <template #header>
            <div class="flex justify-between items-center">
                ...
                <div class="flex gap-2">
                    ...
                    <Link :href="route('kasir.products.edit', product.id)" class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded">
                        Edit
                    </Link>
                    <Link :href="route('kasir.products.index')" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
                        Kembali
                    </Link>
                </div>
            </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50 dark:bg-gray-800">
                                    <tr>
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Harga Beli/Unit</th>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <tr v-for="stockIn in product.stockIns" :key="stockIn.id" class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-xs text-gray-500 dark:text-gray-400 hidden xl:table-cell">
                                            <AuditInfo :user="stockIn.creator" :timestamp="stockIn.created_at" label="Dibuat" />
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-xs text-gray-500 dark:text-gray-400 hidden xl:table-cell">
                                            <AuditInfo :user="stockIn.updater" :timestamp="stockIn.updated_at" label="Diubah" />
                                        </td>
