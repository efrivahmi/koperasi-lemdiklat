...
const submit = () => {
    form.post(route('kasir.stock-ins.store'));
};
</script>
                    ...
                    <div class="p-8">
                        <form @submit.prevent="submit" class="space-y-8">
                            ...
                            <div class="flex flex-col sm:flex-row items-center gap-4 pt-4">
                                ...
                                <Link :href="route('kasir.stock-ins.index')" class="w-full sm:w-auto inline-flex items-center justify-center px-8 py-3.5 bg-slate-700 hover:bg-slate-600 text-white font-semibold rounded-xl border border-white/10 transition-all duration-200">
