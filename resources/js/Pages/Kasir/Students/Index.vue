                ...
                <div class="mb-6 bg-slate-800/50 backdrop-blur-md border border-white/10 rounded-xl shadow-2xl p-4">
                    <div class="flex flex-col lg:flex-row gap-4 items-stretch lg:items-center">
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <Link v-if="can('students.create')" :href="route('kasir.students.create')" class="flex-1 sm:flex-initial inline-flex items-center justify-center px-5 py-2.5 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white font-semibold rounded-lg shadow-lg shadow-indigo-500/20 hover:shadow-indigo-500/40 transition-all duration-200 transform hover:-translate-y-0.5">
                                <svg class="w-5 h-5 sm:mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <tbody class="divide-y divide-white/5">
                                    <tr v-for="student in students.data" :key="student.id" :class="{ 'bg-indigo-500/10': isSelected(student.id), 'hover:bg-white/5': !isSelected(student.id) }" class="transition-colors">
                                        ...
                                        <td class="px-4 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex items-center gap-2">
                                                <Link v-if="can('students.view')" :href="route('kasir.students.show', student.id)" class="text-sky-400 hover:text-sky-300 transition-colors">Detail</Link>
                                                ...
                                                <Link v-if="can('students.edit')" :href="route('kasir.students.edit', student.id)" class="text-indigo-400 hover:text-indigo-300 transition-colors">Edit</Link>
                                                <Link v-if="can('students.edit')" :href="route('kasir.students.rfid.register', student.id)" class="text-emerald-400 hover:text-emerald-300 transition-colors">RFID</Link>
