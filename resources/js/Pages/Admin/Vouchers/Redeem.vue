...
const redeemVoucher = async () => {
    ...
    try {
        ...
        if (response.data.success) {
            showMessage('Voucher berhasil di-redeem!', 'success');
                    ...
                    <div class="p-6">
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <TextInput id="voucher_code" v-model="voucherCode" type="text" class="mt-1 block w-full" placeholder="VCR-XXXXXXXX" />
                            </div>
