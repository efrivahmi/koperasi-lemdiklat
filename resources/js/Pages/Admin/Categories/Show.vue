            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-10 space-y-8">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex gap-3">
                        ...
                        <Link :href="route('categories.edit', category.id)" class="inline-flex items-center px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white font-medium rounded-lg shadow-lg shadow-indigo-500/30 transition-all">
